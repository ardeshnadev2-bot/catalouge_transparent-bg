...
const galleryData: GalleryItem[] = [
  ...
  {
    id: 'gal-yellow-red-closures',
    title: 'Yellow & Red Retractable Closures',
    category: 'products',
    categoryLabel: 'Products',
    image: '/images/gallery_yellow_red_closures.png',
    description: 'Side-by-side display of yellow and red plastic retractable closures in closed and partial-opening configurations.',
    icon: Box,
    aspect: 'aspect-[4/3]',
  },
  {
    id: 'gal-red-retractable-spout',
    title: 'Red Retractable Spout Insert',
    category: 'products',
    categoryLabel: 'Products',
    image: '/images/gallery_red_retractable_spout.png',
    description: 'Close-up profile of a closed red plastic retractable spout showing tamper-evident ring mechanism.',
    icon: Box,
    aspect: 'aspect-square',
  },
  {
    id: 'gal-extended-black-spout',
    title: 'Extended Black Retractable Spout',
    category: 'products',
    categoryLabel: 'Products',
    image: '/images/gallery_extended_black_spout.png',
    description: 'Extended black retractable spout closure installed on container neck showing smooth pour spout.',
    icon: Box,
    aspect: 'aspect-square',
  },
  {
    id: 'gal-red-threaded-caps',
    title: 'Red Threaded Safety Closures',
    category: 'products',
    categoryLabel: 'Products',
    image: '/images/gallery_red_threaded_caps.png',
    description: 'Stack of red plastic threaded caps showing interior sealing gasket and tamper protection.',
    icon: Box,
    aspect: 'aspect-[3/2]',
  },
  {
    id: 'gal-tin-container-spout',
    title: 'Tin Container Retractable Spout',
    category: 'products',
    categoryLabel: 'Products',
    image: '/images/gallery_tin_container_spout.png',
    description: 'Tin container fitted with red pull-out spout closure and custom pull ring.',
    icon: Box,
    aspect: 'aspect-square',
  },
];
