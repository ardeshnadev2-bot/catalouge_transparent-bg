...
export default function IndustriesSection() {
  ...
  return (
    <section
      id="industries"
      className="scroll-mt-20 py-12 lg:py-20 bg-gradient-to-b from-blue-50/20 via-transparent to-transparent dark:from-slate-950/40 dark:via-slate-900/20 dark:to-transparent relative overflow-hidden z-10"
    >
